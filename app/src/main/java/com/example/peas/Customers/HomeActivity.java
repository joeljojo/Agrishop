...
import com.example.peas.SupportCenter.SupportMaintainProductsActivity;
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model)
                    {
                        ...
                        holder.buttonsend.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (type.equals("Admin")){
                                    Intent intent = new Intent(HomeActivity.this, SupportMaintainProductsActivity.class);
                                    ...
                                    intent.putExtra("PAvail",model.getPavail());
